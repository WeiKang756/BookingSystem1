  ...
  return (
    <div>
      <h2 id="service-heading" data-cy="ServiceHeading">
        <Translate contentKey="simpleBookingSystemApp.service.home.title">Services</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="simpleBookingSystemApp.service.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/service/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="simpleBookingSystemApp.service.home.createLabel">Create new Service</Translate>
          </Link>
        </div>
      </h2>
        ...
        {serviceList && serviceList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="simpleBookingSystemApp.service.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="simpleBookingSystemApp.service.home.notFound">No Services found</Translate>
            </div>
          )
        )}
      </div>
