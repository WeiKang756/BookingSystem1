...
export const ServiceDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="simpleBookingSystemApp.service.delete.question">
        <Translate contentKey="simpleBookingSystemApp.service.delete.question" interpolate={{ id: serviceEntity.id }}>
