        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/appointments/*/approve-test")).permitAll()
                    .requestMatchers(mvc.pattern("/api/appointments/*/reject-test")).permitAll()
                    .requestMatchers(mvc.pattern("/api/appointments/*/complete-test")).permitAll()
